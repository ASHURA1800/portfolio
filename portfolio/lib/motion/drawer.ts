...
/**
 * Mobile navigation drawer for the sidebar's collapse/drawer behavior.
 * Slides in from the left edge, matching the sidebar's actual screen
 * position. Uses EASE_IN_OUT rather than EASE_OUT since a drawer both
 * enters and exits along the identical path — a symmetric ease reads
 * more natural than an ease-out exit for that motion.
 */
