...
export const FloatingTextarea = forwardRef<HTMLTextAreaElement, FloatingTextareaProps>(function FloatingTextarea(
  { label, hint, showCount, maxLength, id, value, required, disabled, rows = 3, className, onFocus, onBlur, ...rest },
  ref
) {
  const autoId = useId();
    ...
    <div className="flex flex-col gap-1.5">
      <div className="relative">
        <textarea
          ...
          className={cn(
            'peer w-full bg-[var(--color-surface)] border rounded-[var(--radius-md)] px-3.5 pt-5 pb-2.5 text-sm text-[var(--color-ink)] resize-y',
        ...
        <motion.label
          ...
          animate={floated ? { top: '0.4rem', fontSize: '0.6875rem' } : { top: '0.875rem', fontSize: '0.875rem' }}
